...
// VGG16
// vector<uint32_t> layer_paras = { 7168, 147712, 295424, 590336, 1180672, 2360320, 2360320, 4720640, 9439232, 9439232, 9439232, 9439232, 9439232, 411058176, 67125248, 16404388 };
// uint32_t fp_op_times1[] = { 9547, 48611, 46150, 69618, 15538, 27816, 27792, 16716, 28258, 28215, 16981, 16983, 16982, 3306, 524, 214 };
// uint32_t bp_op_times1[] = { 537, 1619, 7461, 33384, 33410, 33404, 75713, 75904, 51096, 103363, 103226, 101688, 212042, 93848, 201672, 7815 };
// uint32_t fp_op_times2[] = { 7638, 38888, 36920, 55694, 12430, 22253, 22234, 13373, 22606, 22572, 13585, 13586, 13586, 2645, 419, 171 };
// uint32_t bp_op_times2[] = { 430, 1295, 5969, 26707, 26728, 26723, 60570, 60723, 40877, 82690, 82580, 81350, 169634, 75079, 161338, 6252 };
// AlexNet
// vector<uint32_t> layer_paras = { 139776, 2458624, 3540480, 5309952, 3539968, 151011328, 67125248, 16404388 };
// uint32_t fp_op_times1[] = { 33968, 14972, 68179, 103930, 65963, 10765, 4808, 1365 };
// uint32_t bp_op_times1[] = { 2373, 7400, 10137, 122581, 175306, 125696, 108197, 32939 };
// uint32_t fp_op_times2[] = { 27175, 11978, 54544, 83144, 52771, 8612, 3847, 1092 };
// uint32_t bp_op_times2[] = { 1899, 5920, 8110, 98065, 140245, 100557, 86558, 26352 };
// OverFeat
vector<uint32_t> layer_paras = { 139776, 2458624, 4720640, 18878464, 37752832, 452997120, 50348032, 16404388 };
uint32_t fp_op_times1[] = { 48142, 19887, 31526, 107370, 194317, 38218, 4568, 1768 };
uint32_t bp_op_times1[] = { 3310, 5445, 43543, 383997, 303899, 111808, 144785, 48388 };
uint32_t fp_op_times2[] = { 38514, 15909, 25221, 85896, 155454, 30575, 3654, 1415 };
uint32_t bp_op_times2[] = { 2648, 4356, 34834, 307198, 243119, 89446, 115828, 38711 };
